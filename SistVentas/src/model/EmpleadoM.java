...
public class EmpleadoM {
    ...
    public EmpleadoM(int idempleado, String nombres, String apellidos, String dni, String sexo, Date fechanac, String telefono, String celular, String direccion, String distrito, String cargo, String especialidad, String estado) {
        this.idempleado = idempleado;
        this.nombres = nombres;
        this.apellidos = apellidos;
        this.dni = dni;
